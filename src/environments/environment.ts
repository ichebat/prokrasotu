...
export const environment = {
  ...
  owner: {
    ...
    deliveryInfo: [
      ...
      'Заказы отправляются курьером на следующий рабочий день, после обработки заказа.',
      'Заказы доставляются в ТК на следующий рабочий день, после обработки заказа.',
      'При поступлении заказа с Вами свяжутся по телефону уточнят детали заказа.',
